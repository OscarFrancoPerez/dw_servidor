<!DOCTYPE html>
  ...
  <aside style="background-color: white">
    ...
    <hr>
      <ul>
      <?php
        $query2 = 'SELECT tComentarios.comentario, tComentarios.fecha, tUsuarios.nombre FROM tComentarios, tUSuarios WHERE tComentarios.usuario_id=tUsuarios.id AND tComentarios.juego_id='.$juego_id;
